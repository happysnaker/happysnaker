...
> **Point-in-time proof snapshot (2026-07-11):** `qq-ai-bot` and `RDLeader` had **0 open CodeQL / Dependabot / secret-scanning alerts**, and the tracked `qq-ai-bot` CI / CodeQL / Docker publish / arm64 smoke plus `RDLeader` CI / CodeQL were green. Run `python3 scripts/check_github_status.py --summary` for the live status before quoting current state. Current concrete asks live at [support/#current-asks](https://happysnaker.github.io/support/#current-asks): `qq-ai-bot #26 arm64`, `RDLeader #27`, or the ¥29.9 quick read; if you want proof before tipping or buying a review, start at [support/#proof-before-payment](https://happysnaker.github.io/support/#proof-before-payment).

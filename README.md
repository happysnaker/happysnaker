...
- Writing technical documentation and engineering notes that make complex systems easier to understand

## What I do

- Backend engineering with Go / Java
- Infrastructure and RPC-oriented system design
- Technical writing, docs improvements, and developer education
- Practical, implementation-first problem solving grounded in CS fundamentals

## Selected work

- **[Resume](https://github.com/happysnaker/Resume)** — responsive résumé / personal-site template with 160+ stars
- **[Gobang](https://github.com/happysnaker/Gobang)** — C++ Gomoku project with game AI scoring logic and a complete playable implementation
...
Strengths:      CS fundamentals, hands-on implementation, technical writing

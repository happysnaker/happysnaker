...
| [`review / deploy-read funnel`](https://happysnaker.github.io/review/) | Paid review / deploy-read conversion surface | Review page, deploy-read sample, support page, mailto templates, and CI-backed `check_review_funnel.py` now keep `¥29.9` / `¥99` paths visible | Keep `Deploy read` visible from profile, sponsor packet, support files, and share kit; verify with `python3 scripts/check_review_funnel.py --site-root ../happysnaker.github.io --live --timeout 8 --json` |

...
Every support or outreach surface should satisfy four properties before asking for money, a review, or an external update:
...
| Support / Pages funnel | support page, `qq-ai-bot`, `RDLeader`, review page, deploy-read sample | `python3 scripts/check_site_hygiene.py --site-root ../happysnaker.github.io --live --timeout 8 --json`; `python3 scripts/check_review_funnel.py --site-root ../happysnaker.github.io --live --timeout 8 --json` | Pages require scorecard links and Hot / Warm / Nurture / No-send before support or paid-review asks |

...
Recently shipped sponsorware slice: `RDLeader #2`.
...
| `RDLeader` | Next sponsorware slice opened: runtime and approval deep dive | [#14](https://github.com/happysnaker/RDLeader/issues/14) |

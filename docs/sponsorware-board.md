...
| `qq-ai-bot` | arm64 / CasaOS validation | Multi-arch image evidence documented; real CasaOS/arm64 install report still open | [#26](https://github.com/happysnaker/qq-ai-bot/issues/26) |

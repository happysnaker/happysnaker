...
| [`qq-ai-bot`](https://github.com/happysnaker/qq-ai-bot) | flagship bot infrastructure / OneBot + ACP | `SUPPORT.md`, `.github/SUPPORT.md`, funding link, support page, arm64/CasaOS tester pack | [3916000](https://github.com/happysnaker/qq-ai-bot/commit/3916000) | `sponsorware` topic; project homepage; tester pack routes #26 physical-host validation |

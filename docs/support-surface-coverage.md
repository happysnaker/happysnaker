...
Latest broader check: `python3 scripts/check_public_links.py --scope profile --timeout 6` checked 135 public links across README and core proof docs. Site metadata follow-up also verified canonical, OpenGraph image, Twitter card, JSON-LD, and refreshed sitemap `lastmod` coverage for changed project landing pages.

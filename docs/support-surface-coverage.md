...
| [`RDLeader`](https://github.com/happysnaker/RDLeader) | agent-ops / local-first control plane | `README.md`, `SUPPORT.md`, `.github/SUPPORT.md`, funding link, proof-before-payment, support page | [security proof](https://github.com/happysnaker/RDLeader/commit/58768cc), [support proof path](https://github.com/happysnaker/RDLeader/commit/e83ff4d) | `sponsorware` topic; project homepage; support docs now route proof-before-payment and current asks while preserving license/reuse caveats |

...
Latest coverage security sweep: 2026-07-10 checked open Dependabot and secret-scanning alerts for the core support surfaces after RDLeader drizzle-orm remediation; `happysnaker`, `qq-ai-bot`, `RDLeader`, and `happysnaker.github.io` returned `[]` for open Dependabot and secret-scanning alerts. RDLeader runtime path hardening, canonical employee-id routing, Fastify rate limiting, README/SUPPORT evidence surfacing, and the live RDLeader project-page security section then passed [CI](https://github.com/happysnaker/RDLeader/actions/runs/29097583133), [CodeQL](https://github.com/happysnaker/RDLeader/actions/runs/29097583129), and [Pages deploy](https://github.com/happysnaker/happysnaker.github.io/actions/runs/29098623836), reducing RDLeader open CodeQL alerts from 30 to 0 and making the clean alert surface visible from both the repository front door and the public project page. Do not generalize this to older repositories that do not have CodeQL configured.

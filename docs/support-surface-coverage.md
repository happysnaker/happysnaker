...
| [`qq-ai-bot`](https://github.com/happysnaker/qq-ai-bot) | flagship bot infrastructure / OneBot + ACP | `SUPPORT.md`, `.github/SUPPORT.md`, funding link, support page, support issue #28, arm64/CasaOS tester pack, homelab outreach kit | [#28 refresh](https://github.com/happysnaker/qq-ai-bot/issues/28#issuecomment-4937415575), [18413c3](https://github.com/happysnaker/qq-ai-bot/commit/18413c3) | `sponsorware` topic; project homepage; support issue now routes current asks and #26 physical-host validation |
...
| [`.github`](https://github.com/happysnaker/.github) | account-wide community-health defaults | `SUPPORT.md`, `.github/SUPPORT.md`, `CONTRIBUTING.md`, funding link, proof-before-payment path, current asks, support page | [4423803](https://github.com/happysnaker/.github/commit/4423803) | `sponsorware`, `oss-maintenance`; default support routes now expose concrete payment notes and proof-before-payment |
...
Latest proof-surface link check: `python3 scripts/check_public_links.py --timeout 6` checked 74 core sponsor/support/status links across `.github/SUPPORT.md`, sponsor one-pager, support coverage, and the flagship status snapshot. Site metadata follow-up verified local/live canonical, OpenGraph image, Twitter card, JSON-LD, public repo-link hygiene, and the RDLeader sitemap `lastmod` refresh; the reusable site hygiene verifier checked 140 assertions with `python3 scripts/check_site_hygiene.py --site-root ../happysnaker.github.io --live --timeout 8`. The live support page now has a `Proof before payment` section linking the flagship status snapshot, profile CI / CodeQL proof, maintenance proof, support coverage, and current concrete payment notes ([site commit](https://github.com/happysnaker/happysnaker.github.io/commit/d4c554b), [Pages deploy](https://github.com/happysnaker/happysnaker.github.io/actions/runs/29134563962)).

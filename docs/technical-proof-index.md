...
- Public link checker: [scripts/check_public_links.py](../scripts/check_public_links.py) ([commit](https://github.com/happysnaker/happysnaker/commit/6af92879d651342ad5958f45f75981bc0ed08521)); latest core run checked 72 public links across sponsor/support/status docs, and latest profile-scope run checked 299 public links across README, this technical proof index, the flagship status snapshot, the upstream contribution ledger, and core proof docs.

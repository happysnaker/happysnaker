...
- README badge checker: [scripts/check_readme_badges.py](../scripts/check_readme_badges.py) — verifies first-screen CI / CodeQL badges and remote workflow-file existence for profile, `qq-ai-bot`, and `RDLeader`; supports `--json` for machine-readable first-screen badge state.

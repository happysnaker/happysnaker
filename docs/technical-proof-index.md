...
- External follow-up checker: [scripts/check_external_followups.py](../scripts/check_external_followups.py) — summarizes the tracked external PRs plus `qq-ai-bot#26` and `RDLeader#27` with next-action guidance, without posting comments.

...
- Sponsor conversion scorecard: [sponsor-conversion-scorecard.md](sponsor-conversion-scorecard.md) — measurable landing → proof → route → action → follow-up stages for sponsor, tester, curator, and paid-review conversion without spam.
...
- Sponsor conversion scorecard checker: [scripts/check_sponsor_conversion_scorecard.py](../scripts/check_sponsor_conversion_scorecard.py) — verifies the conversion scorecard keeps measurable landing/proof/route/action/follow-up/blocker stages, segment-to-offer fit, concrete support notes, proof links, copy-safe snippet, and no-spam/privacy/license guardrails intact; supports `--json` for machine-readable funnel / segment / guardrail status.

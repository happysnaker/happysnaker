...
- Payment screenshot privacy guard: support/review/qq-ai-bot Pages mailto templates now require private email-only payment evidence, and `scripts/check_review_funnel.py` rejects the old public-issue-risky `Payment screenshot: attached` marker.

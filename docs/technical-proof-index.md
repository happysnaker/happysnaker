...
- Support page proof-before-payment section: <https://happysnaker.github.io/support/#proof-before-payment> ([proof section](https://github.com/happysnaker/happysnaker.github.io/commit/d4c554b), [technical-map route](https://github.com/happysnaker/happysnaker.github.io/commit/c20b732), [Pages deploy](https://github.com/happysnaker/happysnaker.github.io/actions/runs/29138829504))
...
- External follow-up checker: [scripts/check_external_followups.py](../scripts/check_external_followups.py) — summarizes the tracked external PRs plus `qq-ai-bot#26` and `RDLeader#27` without posting comments.
...
- Public link checker: [scripts/check_public_links.py](../scripts/check_public_links.py) ([commit](https://github.com/happysnaker/happysnaker/commit/6af92879d651342ad5958f45f75981bc0ed08521)); latest core run checked 83 public links across `.github/SUPPORT.md`, profile issue contact links, sponsor/support/status docs, and the flagship status snapshot.

...
- Sponsor prospect pipeline: [sponsor-prospect-pipeline.md](sponsor-prospect-pipeline.md) — evidence-first audience routing for homelab testers, bot builders, curators, sponsors, RDLeader evaluators, and paid-review customers.
- Sponsor conversion scorecard: [sponsor-conversion-scorecard.md](sponsor-conversion-scorecard.md) — qualification gates plus measurable landing → proof → route → action → follow-up stages for sponsor, tester, curator, and paid-review conversion without spam.
- Sponsor scorecard coverage: [sponsor-scorecard-coverage.md](sponsor-scorecard-coverage.md) — coverage map proving where Hot / Warm / Nurture / No-send is enforced across support pages, repo support files, live issues, review funnel, and external follow-up.
- Share kit: [share-kit.md](share-kit.md) — audience routing matrix plus copy-ready X / LinkedIn / WeChat / curator snippets and sponsor / paid-support intake replies with proof, privacy, and public-tracker guardrails
...
- Support page sponsor-intake guardrails: <https://happysnaker.github.io/support/#public-intake-guardrail> routes payment/review questions to sponsor / paid-support intake replies and public-privacy guardrails ([Pages commit](https://github.com/happysnaker/happysnaker.github.io/commit/31aecf3)).
- Support page 10-second sponsor router: <https://happysnaker.github.io/support/#sponsor-router> ([support router commit](https://github.com/happysnaker/happysnaker.github.io/commit/ed1ecde), [hero route commit](https://github.com/happysnaker/happysnaker.github.io/commit/e5e44e2))
- Systems-study project-page intake guardrails: `HRpc` and `CSAPPLabsAndNotes` Pages now expose canonical/share metadata, sponsor / paid-support intake replies, public-privacy guardrails, and support-router routing ([Pages commit](https://github.com/happysnaker/happysnaker.github.io/commit/96b2d00)).
- Project-page sponsor-intake guardrails / flagship project-page sponsor-intake/privacy markers: `qq-ai-bot`, `RDLeader`, and the support-funnel project pages now link; support-funnel project-page intake refresh covered sponsor / paid-support intake replies and public-privacy guardrails ([flagship Pages commit](https://github.com/happysnaker/happysnaker.github.io/commit/9eea8b1), [support-funnel Pages commit](https://github.com/happysnaker/happysnaker.github.io/commit/1c7d450)).
...
- chinese-independent-developer support-intake guardrails: indie monetization-list README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([indie-list commit](https://github.com/happysnaker/chinese-independent-developer/commit/e1ec861)).
- go-http-middleware-kit support-intake guardrails: Go-middleware README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([go middleware commit](https://github.com/happysnaker/go-http-middleware-kit/commit/48f5954)).
- go-service-starter support-intake guardrails: Go-starter README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([go starter commit](https://github.com/happysnaker/go-service-starter/commit/a0d466c)).
- happydb support-intake guardrails: database-internals README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([happydb commit](https://github.com/happysnaker/happydb/commit/493ba48)).
- production-readiness-checklist support-intake guardrails: launch-readiness README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([production-readiness commit](https://github.com/happysnaker/production-readiness-checklist/commit/984a08b)).
- system-design-checklist support-intake guardrails: architecture-review README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([system-design commit](https://github.com/happysnaker/system-design-checklist/commit/5265d50)).
- backend-engineer-checklist support-intake guardrails: backend-readiness README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([backend checklist commit](https://github.com/happysnaker/backend-engineer-checklist/commit/3c8e52f)).
- github-profile-checklist support-intake guardrails: paid-review checklist README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([checklist commit](https://github.com/happysnaker/github-profile-checklist/commit/f173d65)).
- CSAPPLabsAndNotes support-intake guardrails: pinned systems-study README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([CSAPP commit](https://github.com/happysnaker/CSAPPLabsAndNotes/commit/e696571)).
- Resume support-intake guardrails: high-traffic `Resume` README/support/funding/contact links now route to proof-before-payment, the 10-second support router, sponsor / paid-support intake replies, deploy-read sample, and public-privacy guardrails ([Resume commit](https://github.com/happysnaker/Resume/commit/bc58edc)).
- Account-wide default support files: <https://github.com/happysnaker/.github/blob/main/SUPPORT.md> and <https://github.com/happysnaker/.github/blob/main/.github/SUPPORT.md> ([support commit](https://github.com/happysnaker/.github/commit/4423803), [share-kit commit](https://github.com/happysnaker/.github/commit/7bbaab8), [deploy-read defaults](https://github.com/happysnaker/.github/commit/a747985), [support-router defaults](https://github.com/happysnaker/.github/commit/0ec8ed7), [funding fallback](https://github.com/happysnaker/.github/commit/47eaa73), [sponsor intake fallback](https://github.com/happysnaker/.github/commit/b5ddf88)) route repositories without local support files to the same proof-before-payment, 10-second support-router, share-kit, sponsor / paid-support intake replies, deploy-read, public-privacy guardrails, and concrete payment-note flow.
- Flagship repo support files: `qq-ai-bot` [SUPPORT.md](https://github.com/happysnaker/qq-ai-bot/blob/main/SUPPORT.md) / [.github/SUPPORT.md](https://github.com/happysnaker/qq-ai-bot/blob/main/.github/SUPPORT.md) and `RDLeader` [SUPPORT.md](https://github.com/happysnaker/RDLeader/blob/main/SUPPORT.md) / [.github/SUPPORT.md](https://github.com/happysnaker/RDLeader/blob/main/.github/SUPPORT.md) now route to proof-before-payment, current asks, share kit, sponsor / paid-support intake replies, public-privacy guardrails, and deploy-read paid-review paths ([qq-ai-bot support proof](https://github.com/happysnaker/qq-ai-bot/commit/b97bc42), [qq-ai-bot deploy-read route](https://github.com/happysnaker/qq-ai-bot/commit/0f13edc), [qq-ai-bot sponsor intake guardrails](https://github.com/happysnaker/qq-ai-bot/commit/af2fa9b), [RDLeader support proof](https://github.com/happysnaker/RDLeader/commit/e83ff4d), [RDLeader deploy-read route](https://github.com/happysnaker/RDLeader/commit/2b0ad6a), [RDLeader sponsor intake guardrails](https://github.com/happysnaker/RDLeader/commit/69bab33)).
...
- Profile preflight runner: [scripts/run_profile_preflight.py](../scripts/run_profile_preflight.py) — wraps public-docs, stable profile-link, GitHub CLI helper usage, checker catalog JSON, preflight JSON contract, share-kit, offer-card, sponsor prospect pipeline, sponsor conversion scorecard, sponsor scorecard coverage, README badge, GitHub status, support-route, metadata, sponsor-release, sponsor-issue, paid-review funnel, operations-log, issue-label, manual-blocker, public-link, and external-follow-up checks into one command; `--json` now forwards JSON mode to checker substeps so the captured preflight stdout is parseable, and it also supports `--external-only`, external `--action-class` filters, `--external-summary`, `--external-candidate-comments`, and scheduled-review due gating.
- Preflight JSON contract checker: [scripts/check_preflight_json_contract.py](../scripts/check_preflight_json_contract.py) — verifies `run_profile_preflight.py --json` forwards JSON mode into checker substeps, keeps normal non-JSON output human-readable except always-JSON gates, and keeps external-only optional-update output parseable; supports `--json` for machine-readable preflight-contract state.
- Public docs verifier: [scripts/verify_public_docs.py](../scripts/verify_public_docs.py) — verifies public markdown files for required proof/support text, sensitive-pattern hygiene, and local-link integrity; CI and preflight run `python3 scripts/verify_public_docs.py --json` for machine-readable file / required-marker / failure state.
- README badge checker: [scripts/check_readme_badges.py](../scripts/check_readme_badges.py) — verifies first-screen CI / CodeQL badges, remote workflow-file existence for profile / `qq-ai-bot` / `RDLeader`, and first-screen support/proof routes to proof-before-payment, current asks, sponsor router, sponsor prospect pipeline, sponsor conversion scorecard, and deploy-read sample; supports `--json` for machine-readable first-screen badge/support state.
- Stable profile proof-link checker: [scripts/check_stable_profile_links.py](../scripts/check_stable_profile_links.py) — rejects one-off profile self-check run links in public docs; README, proof docs, sponsor release, and the status snapshot use stable profile workflow links instead; supports `--json` for machine-readable proof-link drift state.
...
- GitHub CLI usage checker: [scripts/check_gh_usage.py](../scripts/check_gh_usage.py) — prevents new proof checkers from bypassing the shared retry helper with direct `gh` subprocess calls; supports `--json` for machine-readable helper-usage drift state, including total script count, the expected allowlisted shared helper, and missing/unexpected allowlist drift.
- CI workflow contract checker: [scripts/check_ci_workflow_contract.py](../scripts/check_ci_workflow_contract.py) — verifies scheduled CI keeps compiling every proof checker and keeps the required GH_TOKEN-backed drift checks wired; supports `--json` for machine-readable workflow-contract drift state.
- Operator handoff checker: [scripts/check_operator_handoff.py](../scripts/check_operator_handoff.py) — verifies the first-read handoff keeps current source-of-truth commands, blockers, external-follow-up rules, and overclaim guardrails; supports `--json` for machine-readable handoff drift state (`python3 scripts/check_operator_handoff.py --json`).
- Checker catalog checker: [scripts/check_checker_catalog.py](../scripts/check_checker_catalog.py) — verifies this proof index documents every `scripts/check_*.py` proof checker, including the catalog checker itself, and fails if any proof checker lacks `--json` support via a real argparse `--json` flag, so new checks do not become invisible or text-only; supports `--json` for machine-readable handoff state.
- GitHub status checker: [scripts/check_github_status.py](../scripts/check_github_status.py) — latest run verified profile, qq-ai-bot, RDLeader, and Pages workflows plus configured alert counts; it now falls back to the unfiltered run list for GitHub-generated Pages `dynamic` deployments when the stricter branch-filtered run list misses the workflow, avoiding false missing-run alerts; `--summary` emits compact machine-readable status JSON and `--markdown` generates the shareable [flagship status snapshot](flagship-status-snapshot.md).
- Support route checker: [scripts/check_support_routes.py](../scripts/check_support_routes.py) — verifies profile, default `.github`, `qq-ai-bot`, and `RDLeader` funding/support/README/issue-contact files still route to proof-before-payment, the 10-second support router, current asks, share kit, sponsor / paid-support intake replies, public-privacy guardrails, concrete payment notes, and private email-only payment-evidence mailto wording; this now runs in scheduled profile CI, including weekly drift checks; supports `--json` for machine-readable metadata state.
- Repository metadata checker: [scripts/check_repo_metadata.py](../scripts/check_repo_metadata.py) — verifies 15 portfolio-critical repositories across profile, flagship, Pages, default community-health, support-funnel, systems-study, Go starter/middleware, and indie-list surfaces for homepage, topics, descriptions, visibility, and archive state; this now runs in scheduled profile CI, including weekly drift checks.
...
- Payment screenshot privacy guard: support/review/qq-ai-bot Pages and repository README mailto templates now require private email-only payment evidence; `scripts/check_review_funnel.py` and `scripts/check_support_routes.py` reject the old public-issue-risky `Payment screenshot: attached` marker.
...
- Operations log checker: [scripts/check_ops_issue_log.py](../scripts/check_ops_issue_log.py) — verifies [issue #2](https://github.com/happysnaker/happysnaker/issues/2) remains the open append-only operations log with evidence and verification markers now that the release body is compact; supports `--json` for machine-readable ops-log state.
- Issue label checker: [scripts/check_issue_labels.py](../scripts/check_issue_labels.py) — verifies profile, `qq-ai-bot`, and `RDLeader` sponsor/manual/open-loop issues keep public triage labels such as `sponsorship`, `validation`, `external-follow-up`, `manual-action`, and `license`; supports `--json` for machine-readable label state.
- External follow-up checker: [scripts/check_external_followups.py](../scripts/check_external_followups.py) — summarizes the tracked external PRs plus `qq-ai-bot#26` and `RDLeader#27` with machine-readable action classes, sponsor conversion qualification gates, next-action guidance, materials, prepared candidate comments, candidate-comment guardrails, and `postedFollowupUrl` no-repeat evidence, without posting comments; `--summary` includes a `Posted follow-ups` section when a tracked row already has a public follow-up URL so scheduled reviews do not duplicate external bumps; supports `--action-class` filtering, `--json`, `--summary`, and `--candidate-comments` output for scheduled review.
...
- Manual blockers checker: [scripts/check_manual_blockers.py](../scripts/check_manual_blockers.py) — summarizes the profile-pin and RDLeader-license blockers, verifies [issue #1](https://github.com/happysnaker/happysnaker/issues/1) stays open/labeled/aligned with the latest manual guidance, and verifies [owner-action-packet.md](owner-action-packet.md) keeps the owner-only next actions ready; supports `--json` for machine-readable blocker / owner-action state and `--strict` after both manual actions are complete.
- Share kit checker: [scripts/check_share_kit.py](../scripts/check_share_kit.py) — verifies the audience routing matrix, copy-ready share snippets, and sponsor / paid-support intake replies keep proof-before-payment links, current support notes, privacy boundaries, and overclaim guardrails before they are used for sponsor/project promotion; supports `--json` for machine-readable snippet / guardrail status.
- Offer card checker: [scripts/check_offer_cards.py](../scripts/check_offer_cards.py) — verifies the productized offer cards stay consistent across the profile README, share kit, sponsor scorecard coverage, and Pages support page / JSON-LD checkout; supports `--site-root` for CI Pages checkouts and `--json` for machine-readable offer-card drift state.
- Sponsor prospect pipeline checker: [scripts/check_sponsor_pipeline.py](../scripts/check_sponsor_pipeline.py) — verifies the sponsor prospect pipeline keeps audience segments, coverage ladder layers, current working-list surfaces, proof links, copy-ready reply patterns, the 2026-07-23 external review gate, and no-overclaim/privacy guardrails intact; supports `--json` for machine-readable segment / coverage / guardrail status.
- Sponsor conversion scorecard checker: [scripts/check_sponsor_conversion_scorecard.py](../scripts/check_sponsor_conversion_scorecard.py) — verifies the conversion scorecard keeps qualification gates, measurable landing/proof/route/action/follow-up/blocker stages, segment-to-offer fit, concrete support notes, proof links, copy-safe snippet, and no-spam/privacy/license guardrails intact; supports `--json` for machine-readable qualification / funnel / segment / guardrail status.
- Sponsor scorecard coverage checker: [scripts/check_sponsor_scorecard_coverage.py](../scripts/check_sponsor_scorecard_coverage.py) — verifies the scorecard coverage map keeps profile, Pages, release, live issue, external follow-up, default support, flagship, paid-review, technical-review, systems-study, and indie-list surfaces tied to Hot / Warm / Nurture / No-send gates; supports `--json` for machine-readable coverage-row / guardrail status.
- Public link checker: [scripts/check_public_links.py](../scripts/check_public_links.py) ([commit](https://github.com/happysnaker/happysnaker/commit/6af92879d651342ad5958f45f75981bc0ed08521)); use `--scope core --workers 8 --json` for the core sponsor/support/status surface and `--scope profile --workers 12 --json` for README, proof index, upstream ledger, operations cadence, operator handoff, and core support docs. Treat JSON output as the current link-count source; supports `--json` for machine-readable link status.
- Public site hygiene verifier: [scripts/check_site_hygiene.py](../scripts/check_site_hygiene.py) ([commit](https://github.com/happysnaker/happysnaker/commit/ef88985863a24042f5f8be35c0b2979e44441d71)); profile CI checks a local `happysnaker.github.io` checkout, and manual `--live` runs verify project-page metadata, sitemap, support anchor integrity, public repo-link hygiene, support-page proof-before-payment content, sponsor conversion scorecard routing, flagship, support-funnel, and systems-study project-page sponsor-intake/privacy markers, local/live stable workflow proof links instead of one-off Actions run URLs, and share-kit routing. Treat JSON output as the current assertion-count source; supports `--json` for machine-readable site hygiene status.

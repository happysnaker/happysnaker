...
- Public docs verifier: [scripts/verify_public_docs.py](../scripts/verify_public_docs.py) — verifies public markdown files for required proof/support text, sensitive-pattern hygiene, and local-link integrity; supports `--json` for machine-readable file / required-marker / failure state.

...
- Profile pin checker: [scripts/check_profile_pins.py](../scripts/check_profile_pins.py) — reports whether the recommended technical-first pinned set still requires the manual `Resume` → `RDLeader` swap.

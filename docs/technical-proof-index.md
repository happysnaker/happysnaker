...
- Sponsor release checker: [scripts/check_sponsor_release.py](../scripts/check_sponsor_release.py) — verifies the frozen sponsor one-pager release exists, stays a pre-release proof packet, and still contains proof-before-payment plus concrete payment-note routes.

...
- Account-wide default support files: <https://github.com/happysnaker/.github/blob/main/SUPPORT.md> and <https://github.com/happysnaker/.github/blob/main/.github/SUPPORT.md> ([commit](https://github.com/happysnaker/.github/commit/4423803)) route repositories without local support files to the same proof-before-payment and concrete payment-note flow.
...
- GitHub issue contact links now expose proof-before-payment and current asks from the default `.github` community-health repo, the profile repo, `qq-ai-bot`, and `RDLeader` ([default commit](https://github.com/happysnaker/.github/commit/cb75da3), [qq-ai-bot commit](https://github.com/happysnaker/qq-ai-bot/commit/85a3ce5), [RDLeader commit](https://github.com/happysnaker/RDLeader/commit/e7345e4)).

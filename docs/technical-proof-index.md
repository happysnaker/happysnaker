...
- Checker catalog checker: [scripts/check_checker_catalog.py](../scripts/check_checker_catalog.py) — verifies this proof index documents every `scripts/check_*.py` proof checker so new checks do not become invisible.

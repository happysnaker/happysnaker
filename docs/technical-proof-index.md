...
- Project-page sponsor-intake guardrails: `qq-ai-bot` and `RDLeader` Pages now link sponsor / paid-support intake replies and public-privacy guardrails ([Pages commit](https://github.com/happysnaker/happysnaker.github.io/commit/9eea8b1)).

...
- Public link checker: [scripts/check_public_links.py](../scripts/check_public_links.py) ([commit](https://github.com/happysnaker/happysnaker/commit/6af92879d651342ad5958f45f75981bc0ed08521)); latest core run checked 84 public links across `.github/SUPPORT.md`, profile issue contact links, sponsor/support/status docs, and the flagship status snapshot.

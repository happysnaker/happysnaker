...
REQUIRED_TEXT = (
    ...
    "one real physical ARM / CasaOS / NAS / SBC report added to the public tracker",
    "Keep the RDLeader license caveat visible; this is not a license grant",
    "Only send public links; keep payment evidence private by email",

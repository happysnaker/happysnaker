...
REQUIRED_BODY_TEXT = (
    ...
    "https://github.com/happysnaker/happysnaker/blob/master/docs/share-kit.md#productized-offer-cards",
    ...
    "https://github.com/happysnaker/happysnaker/blob/master/docs/sponsor-conversion-scorecard.md",
    ...
    "Productized offer cards",
    "share-kit.md#productized-offer-cards",

...
REQUIRED = {
    ...
    "docs/sponsor-conversion-scorecard.md": [
        ...
        "Do not imply RDLeader reuse rights",
        "python3 scripts/check_sponsor_conversion_scorecard.py --json",
        "sponsor-scorecard-coverage.md",
    ...
    "docs/support-surface-coverage.md": [
        ...
        "Latest indie-list scorecard refresh",
        "indie-list commit 1a52140",
        ...
        "Latest Go asset scorecard refresh",
        "commit 1a8be9e",
        "commit 4bc66f8",
        "backend-template and middleware buyers through the sponsor conversion scorecard",
        ...
        "Latest happydb scorecard refresh",
        "b58724f",
        "493ba48",
        ...
        "Latest technical-review scorecard refresh",
        "commit 9bb803d",
        "commit 7692155",
        "commit 067b6a5",
        "backend/system/launch review buyers through the sponsor conversion scorecard",
        ...
        "Latest paid-review scorecard refresh",
        "commit 65e9497",
        "commit 9138da7",
        "profile/README buyers through the sponsor conversion scorecard",
        ...
        "Latest CSAPP scorecard refresh",
        "commit aacb6ce",
        ...
        "Latest support-page conversion-scorecard refresh",
        "Pages commit f891887",
        "Hot / Warm / Nurture / No-send",
        "generic donation bumps",
        "sponsor prospect pipeline",
        ...
        "Default sponsor conversion scorecard fallback",
        "Latest profile/default contact scorecard refresh",
        ...
        "Latest review-funnel scorecard refresh",
        "review page and deploy-read sample",
        "Hot / Warm / Nurture / No-send qualification",
        "¥29.9",
        "¥99",
        "https://happysnaker.github.io/review/deploy-read-sample/",
    ...
    "docs/technical-proof-index.md": [
        ...
        "supports `--site-root`",
        "machine-readable offer-card drift state",
        ...
        "2026-07-23 external review gate",
        "prepared candidate comments",
        "candidate-comment guardrails",
        "postedFollowupUrl",
        "Posted follow-ups",
        "do not duplicate external bumps",
